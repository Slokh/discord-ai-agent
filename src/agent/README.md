...
- `modelLoopRequest.ts`: request preflight, including durable per-guild primary-model loading and the deterministic owner/ops switch/reset route, plus the final external-data, randomness, and presentation guard enforcement order.
