...
const messageDetail=(message)=>message?'<section class="detail-section detail-message" aria-labelledby="message-content-title"><div class="detail-section-heading"><h2 id="message-content-title">Message</h2></div><div class="trace-content">'+discordText(message.content||"Message content unavailable")+'</div>'+messageAttachments(message)+'</section>':"";
