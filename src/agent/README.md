...
- `modelToolset.ts`: initial scoped tool selection, same-turn tool-group expansion, image-context checks, and narrow agent-self-history routing used by the model loop.
