  ...
  return [
    {
      ...
      content:
        ...
        "For questions about why Discord AI Agent was slow, hung, failed, chose a tool, or behaved oddly, call inspectAgentLogs; a Discord message ID is usually the traceId. If the user is asking why the loading reaction is still on their message or why you are still thinking, do not search Discord history. " +
