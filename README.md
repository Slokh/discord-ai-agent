...
| `OPENROUTER_CHAT_REASONING_EFFORT` / `OPENROUTER_CHAT_FALLBACK_REASONING_EFFORT` | `high` / `medium` | OpenRouter reasoning effort for primary chat and recovery calls |
