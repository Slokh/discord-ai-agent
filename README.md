...
| `BOT_OWNER_USER_ID` / `OPS_ALLOWLIST_USER_IDS` | unset | Restricted administrative-tool allowlists as Discord user IDs. Code-update tasks are available to every member; owner/ops restrictions still protect administrative mutations. |
