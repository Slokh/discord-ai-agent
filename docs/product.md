...
For failed repair work, the Console shows a bounded, operator-safe failure category (for example, retry exhaustion or a workspace branch collision). Raw task errors, output, prompts, and artifacts stay in the retained production ledger.
