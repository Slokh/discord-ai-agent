...
- `discordPresentationTools.ts`: validates the model-selected semantic Components V2 presentation; Discord IDs, authorization, persistence, compilation, and delivery remain owned by Discord/database code.
