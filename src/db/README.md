...
- Opaque requester/channel-scoped component actions, expiry, binding, and transactional single-use consumption live in `discordComponentActionRepository.ts`; canonical interaction execution remains in `agent_runtime_*`.
