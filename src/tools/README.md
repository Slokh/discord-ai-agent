...
- `spotifyTools.ts`: Spotify Web API client-credentials integration for public catalog search, item details, and playlist track attachments with current API limits and sanitized stored output.
