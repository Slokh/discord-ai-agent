...
export function improvementReportTriagePrompt(env: CodegenPromptEnv, contextPack?: CodegenPromptContextPack) {
  ...
  return [
    ...
    "Treat a later latestDeploymentVerification as authoritative recovery evidence for deployment incidents whose trusted check is satisfied by a successful rollout; use already_fixed rather than proposing redundant code work. Do not treat deployment success alone as proof that unrelated runtime behavior recovered.",
