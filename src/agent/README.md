...
- `modelPolicy.ts`: applies the primary conversational model, reasoning effort, and completion budget, then selects the stronger recovery model only for malformed/empty model output or repeated-tool termination.
